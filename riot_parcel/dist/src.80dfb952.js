...
},{}],"../js/tags.js":[function(require,module,exports) {
"use strict";
...
_riot.default.tag2('app', '<test></test> <app-footer></app-footer>', 'app,[data-is="app"]{ display: block; min-height: 100vh; } app::before,[data-is="app"]::before{ content: ""; position: absolute; top: 0; left: 0; z-index: -1; width: 100%; height: 100%; opacity: 0.6; background: url("img/test3.jpg") 0 0 no-repeat/cover; }', '', function (opts) {});

_riot.default.tag2('app-footer', '<p>{opts.message} - {year}</p>', 'app-footer,[data-is="app-footer"]{ display: block; } app-footer p,[data-is="app-footer"] p{ font-size: 100%; }', '', function (opts) {
...
},{}],"../styles/common.styl":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
