...
riot.tag2('inputurl', '<div class="input-field"> <i class="material-icons prefix">textsms</i> <input type="text" id="inputUrl" ref="inputUrl" oninput="{urlInputCompleted}"> <label for="inputUrl">URLを入力</label> </div>', 'inputurl,[data-is="inputurl"]{ display: block; flex: 1; } inputurl .material-icons,[data-is="inputurl"] .material-icons{ margin-top: 0.5rem; } inputurl label,[data-is="inputurl"] label{ height: 2rem; }', '', function(opts) {
